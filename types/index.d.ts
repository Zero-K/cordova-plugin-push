...
// Project: https://github.com/Zero-K/cordova-plugin-push
...
declare namespace PhonegapPluginPush {
	...
	interface InitOptions {
		...
		ios?: {
			 ...
			 * Action Buttons on iOS - https://github.com/Zero-K/cordova-plugin-push/blob/master/docs/PAYLOAD.md#action-buttons-1
			 */
